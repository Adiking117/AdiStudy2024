...
class Employee{
    ...
    public:
        ...
        void display() {
            cout << "Hours: " << this->hours << " "<< &this->hours << ", Rate: " << this->rate << " "<<  &this->rate << endl;
        }
};
...
int main(){
    ...
    // Display object size
    cout << "Size of Employee object: " << sizeof(Employee) << " bytes" << endl;
	
	int* hourPtr = (int *)(e);
	*hourPtr = 200;
	float* ratePtr = (float *)(hourPtr+1);
	*ratePtr = 220;
	
	// Debugging memory layout
    cout << "Address of object: " << e << endl;
    cout << "Address of 'hours': " << hourPtr << endl;
    cout << "Address of 'rate': " << ratePtr << endl;
